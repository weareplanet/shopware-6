...
// The previous import block here listed SDK models under WeArePlanetPayment\Sdk, which is
...
class CheckoutSubscriber implements EventSubscriberInterface
{
	 ...
	 * @return void
	 */
	private function removeWeArePlanetPaymentMethodFromConfirmPage($event): void
	{
	...
	/**
	 * Updates the WeArePlanet transaction when the payload that would be sent differs from
