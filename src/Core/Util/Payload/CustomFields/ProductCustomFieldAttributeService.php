...
namespace WeArePlanetPayment\Core\Util\Payload\CustomFields;
...
class ProductCustomFieldAttributeService
{
    ...
    /**
     *
     * @return array<string, array<string, \WeArePlanet\Sdk\Model\LineItemAttributeCreate>>
     *
     * @throws \WeArePlanetPayment\Core\Util\Exception\InvalidPayloadException
     */
