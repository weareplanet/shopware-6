...
use WeArePlanetPayment\Core\Checkout\Service\InvoiceService;
...
class InvoiceRoute
{
     ...
     */
    #[Route(
        path: '/store-api/weareplanet/account/order/invoice/{orderId}',
        name: 'store-api.weareplanet.account.order.invoice',
        methods: ['GET']
    )]
