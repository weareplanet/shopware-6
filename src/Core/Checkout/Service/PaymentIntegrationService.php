...
use WeArePlanetPayment\Core\Settings\Options\Integration;
use WeArePlanetPayment\Core\Settings\Service\SettingsService;
use WeArePlanetPayment\Core\Checkout\Struct\PaymentConfigStruct;
use WeArePlanetPayment\Core\Util\LocaleCodeProvider;
...
class PaymentIntegrationService
{
    ...
    public function getConfigForTransaction(
        ...
        $weareplanetTransaction = $settings->getApiClient()->getTransactionService()->read(
            $settings->getSpaceId(),
            $transactionId
        );
    ...
    {
        return 'https://paymentshub.weareplanet.com/s/' . $spaceId . '/payment/device.js?session=' . Uuid::randomHex();
    }
}
