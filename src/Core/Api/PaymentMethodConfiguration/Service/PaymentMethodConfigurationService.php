...
class PaymentMethodConfigurationService {
	 ...
	 * @var \Shopware\Core\Framework\DataAbstractionLayer\EntityRepositoryInterface
	 */
	private $weArePlanetPaymentMethodConfigurationRepository;
	 ...
	 * @param \Shopware\Core\Framework\DataAbstractionLayer\EntityRepository                             $weArePlanetPaymentMethodConfigurationRepository
	 */
	public function __construct(
		...
		EntityRepository $weArePlanetPaymentMethodConfigurationRepository,
	) {
		...
		$this->weArePlanetPaymentMethodConfigurationRepository = $weArePlanetPaymentMethodConfigurationRepository;
	...
	private function disablePaymentMethodConfigurations(Context $context): void
	{
		...
		$paymentMethodConfigurationEntities = $this->weArePlanetPaymentMethodConfigurationRepository
		...
		if (!empty($paymentMethodConfigurationEntities)) {
			...
			try {
				$this->weArePlanetPaymentMethodConfigurationRepository->update($data, $context);
	...
	private function enablePaymentMethodConfigurations(Context $context): void
	{
		...
		foreach ($paymentMethodConfigurations as $paymentMethodConfiguration) {
			...
			$this->weArePlanetPaymentMethodConfigurationRepository->upsert([$data], $context);
		}
	}
	...
	): ?PaymentMethodConfigurationEntity
	{
		...
		return $this->weArePlanetPaymentMethodConfigurationRepository
							   ->search($criteria, $context)
							   ->getEntities()
							   ->first();
	}
	...
	public function getAllPaymentMethodConfigurations(int $spaceId, Context $context): array
	{
		...
		$configurations = $this->weArePlanetPaymentMethodConfigurationRepository
			->search($criteria, $context)
			->getEntities();
