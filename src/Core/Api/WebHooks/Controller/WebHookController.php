...
class WebHookController extends AbstractController {
	...
	/**
	 * @var \WeArePlanetPayment\Core\Api\WebHooks\Strategy\WebHookStrategyManager
	 */
	 ...
	 * @param \WeArePlanetPayment\Core\Api\WebHooks\Strategy\WebHookStrategyManager                                         $settingsService
	 */
	 ...
	 */
	#[Route(
		path: "/api/_action/weareplanet/webHook/callback/{salesChannelId}",
