...
class WebHookTransactionInvoiceStrategy extends WebHookStrategyBase implements WebhookStrategyActionsInterface {
	...
	{
		/** @var \WeArePlanet\Sdk\Model\TransactionInvoice $transaction */
	...
	/**
	 * Processes the WeArePlanet TransactionInvoice webhook request by updating transaction and order states based on the invoice state.
