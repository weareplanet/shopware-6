 ...
 */
#[AsCommand(name: 'weareplanet:settings:create-merchant')]
class CreateMerchantCommand extends Command {
	...
	{
		$output->writeln('Creating WeArePlanetPayment merchant with custom role...');
		...
		$roleId = $this->getOrCreateRoleId('WeArePlanet viewer', $context);
		...
		if (!$roleId) {
			...
			$this->userRoleRepository->create([
				[
					...
					'privileges' => [
						'weareplanet.viewer',
						'weareplanet_sales_channel:read',
						'weareplanet_sales_channel_run:read',
						'weareplanet_sales_channel_run_log:read',
						'language:read',
						'locale:read',
						'system_config:read'
					]
