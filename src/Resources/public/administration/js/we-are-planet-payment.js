...
{% endblock %}
`;var{Component:re,Context:y}=Shopware,ie=Shopware.Data.Criteria,oe="handler_weareplanetpayment_weareplanetpaymenthandler";re.override("sw-order-detail",{template:I,data(){return{isWeArePlanetPayment:!1}},computed:{isEditable(){return!this.isWeArePlanetPayment||this.$route.name!=="weareplanet.order.detail"},showTabs(){return!0}},watch:{orderId:{deep:!0,handler(){if(!this.orderId){this.setIsWeArePlanetPayment(null);return}let e=this.repositoryFactory.create("order"),t=new ie(1,1);t.addAssociation("transactions"),e.get(this.orderId,y.api,t).then(a=>{if(a.amountTotal<=0||a.transactions.length<=0||!a.transactions[0].paymentMethodId){this.setIsWeArePlanetPayment(null);return}let n=a.transactions[0].paymentMethodId;n!=null&&this.setIsWeArePlanetPayment(n)})},immediate:!0}},methods:{setIsWeArePlanetPayment(e){if(!e)return;this.repositoryFactory.create("payment_method").get(e,y.api).then(a=>{this.isWeArePlanetPayment=a.formattedHandlerIdentifier===oe})}}});var C=`{% block weareplanet_order_action_completion %}
...
{% endblock %}
`;var{Component:le,Mixin:ce,Filter:de,Utils:A}=Shopware;le.register("weareplanet-order-action-completion",{template:C,inject:["WeArePlanetTransactionCompletionService"],mixins:[ce.getByName("notification")],props:{transactionData:{type:Object,required:!0}},data(){return{isLoading:!0,isCompletion:!1}},computed:{dateFilter(){return de.getByName("date")}},created(){this.createdComponent()},methods:{createdComponent(){this.isLoading=!1},completion(){this.isCompletion&&(this.isLoading=!0,this.WeArePlanetTransactionCompletionService.createTransactionCompletion(this.transactionData.transactions[0].metaData.salesChannelId,this.transactionData.transactions[0].id).then(()=>{this.createNotificationSuccess({title:this.$tc("weareplanet-order.captureAction.successTitle"),message:this.$tc("weareplanet-order.captureAction.successMessage")}),this.isLoading=!1,this.$emit("modal-close"),this.$nextTick(()=>{this.$router.replace(`${this.$route.path}?hash=${A.createId()}`)})}).catch(e=>{try{this.createNotificationError({title:e.response.data.errors[0].title,message:e.response.data.errors[0].detail,autoClose:!1})}catch{this.createNotificationError({title:e.title,message:e.message,autoClose:!1})}finally{this.isLoading=!1,this.$emit("modal-close"),this.$nextTick(()=>{this.$router.replace(`${this.$route.path}?hash=${A.createId()}`)})}}))}}});var E=`{% block weareplanet_order_action_refund %}
<sw-modal variant="small"
...
{% endblock %}
`;var{Component:Je,Mixin:Xe}=Shopware;Je.register("sw-weareplanet-credentials",{template:B,name:"WeArePlanetCredentials",inject:["acl"],mixins:[Xe.getByName("notification")],props:{actualConfigData:{type:Object,required:!0},allConfigs:{type:Object,required:!0},selectedSalesChannelId:{type:[String,null],required:!1,default:null},spaceIdFilled:{type:Boolean,required:!0},spaceIdErrorState:{required:!0},userIdFilled:{type:Boolean,required:!0},userIdErrorState:{required:!0},applicationKeyFilled:{type:Boolean,required:!0},applicationKeyErrorState:{required:!0},isLoading:{type:Boolean,required:!0},isTesting:{type:Boolean,required:!1}},data(){return{...l}},computed:{currentConfig(){return this.selectedSalesChannelId&&this.allConfigs[this.selectedSalesChannelId]?this.allConfigs[this.selectedSalesChannelId]:this.allConfigs.null||{}}},methods:{checkTextFieldInheritance(e){return!e||e.length<=0},checkNumberFieldInheritance(e){return e==null||e===""},checkBoolFieldInheritance(e){return typeof e!="boolean"},emitCheckApiConnectionEvent(){let e={spaceId:this.currentConfig[l.CONFIG_SPACE_ID],userId:this.currentConfig[l.CONFIG_USER_ID],applicationKey:this.currentConfig[l.CONFIG_APPLICATION_KEY]};this.$emit("check-api-connection-event",e)},getInheritedValue(e){return this.allConfigs.null?.[e]??null}}});var G=`{% block weareplanet_settings_content_card_channel_config_options %}
...
{% endblock %}
`;var{Component:tt,Mixin:at}=Shopware;tt.register("sw-weareplanet-options",{template:G,name:"WeArePlanetOptions",mixins:[at.getByName("notification")],props:{actualConfigData:{type:Object,required:!0},allConfigs:{type:Object,required:!0},selectedSalesChannelId:{required:!0},isLoading:{type:Boolean,required:!0}},data(){return{...l}},computed:{integrationOptions(){return[{id:"payment_page",name:this.$tc("weareplanet-settings.settingForm.options.integration.options.payment_page")},{id:"iframe",name:this.$tc("weareplanet-settings.settingForm.options.integration.options.iframe")}]}},methods:{checkTextFieldInheritance(e){return typeof e!="string"?!0:e.length<=0},checkNumberFieldInheritance(e){return typeof e!="number"?!0:e.length<=0},checkBoolFieldInheritance(e){return typeof e!="boolean"}}});var q=`{% block weareplanet_settings_icon %}
...
{% endblock %}
`;var{Component:rt}=Shopware;rt.register("sw-weareplanet-settings-icon",{template:q});var V=`<mt-card class="mt-card"
...
`;var{Component:ot,Mixin:st}=Shopware;ot.register("sw-weareplanet-storefront-options",{template:V,name:"WeArePlanetStorefrontOptions",mixins:[st.getByName("notification")],props:{actualConfigData:{type:Object,required:!0},allConfigs:{type:Object,required:!0},selectedSalesChannelId:{required:!0},isLoading:{type:Boolean,required:!0}},data(){return{...l}},methods:{checkTextFieldInheritance(e){return typeof e!="string"?!0:e.length<=0},checkNumberFieldInheritance(e){return typeof e!="number"?!0:e.length<=0},checkBoolFieldInheritance(e){return typeof e!="boolean"}}});var z=`<mt-card class="mt-card"
