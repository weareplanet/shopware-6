...
Component.register('weareplanet-settings', {
    ...
    methods: {
        ...
        async onSave() {
            ...
            if (validationError === 'HEADLESS') {
                this.createNotificationError({
                    ...
                    message: this.$tc('weareplanet-settings.settingForm.messageHeadlessIntegrationError')
                });
                ...
                this.createNotificationError({
                    title: this.$tc('weareplanet-settings.settingForm.titleError'),
                    message: this.$tc('weareplanet-settings.settingForm.messageGlobalIframeError')
                });
                this.isLoading = false;
                return;
            }
        ...
        registerWebHooks() {
            ...
            this.WeArePlanetConfigurationService.registerWebHooks(this.selectedSalesChannelId)
                .then(() => {
        ...
        synchronizePaymentMethodConfiguration() {
            ...
            this.WeArePlanetConfigurationService.synchronizePaymentMethodConfiguration(this.selectedSalesChannelId)
                .then(() => {
                    this.createNotificationSuccess({
                        title: this.$tc('weareplanet-settings.settingForm.titleSuccess'),
