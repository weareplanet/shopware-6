...
switch ($release_env) {
	case RELEASE_GIT_ENV:
		exec('composer require weareplanet/sdk 4.0.2 -d /var/www/shopware.local');
		$composerJsonData['require']['weareplanet/sdk'] = '4.0.2';
		break;
	case RELEASE_SW_ENV:
		exec('composer require weareplanet/sdk 4.0.2 -d /var/www/shopware.local/custom/plugins/WeArePlanetPayment');
		break;
}
