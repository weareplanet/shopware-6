...
switch ($release_env) {
	case RELEASE_GIT_ENV:
		exec('composer require weareplanet/sdk 4.4.0 -d /var/www/html');
		$composerJsonData['require']['weareplanet/sdk'] = '4.4.0';
		break;
	case RELEASE_SW_ENV:
		exec('composer require weareplanet/sdk 4.4.0 -d /var/www/html/custom/plugins/WeArePlanetPayment');
		break;
}
