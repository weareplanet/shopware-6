...
switch ($release_env) {
	case RELEASE_GIT_ENV:
		exec('composer require weareplanet/sdk 3.2.0 -d /var/www/shopware.local');
		$composerJsonData['require']['weareplanet/sdk'] = '3.2.0';
		break;
	case RELEASE_SW_ENV:
		exec('composer require weareplanet/sdk 3.2.0 -d /var/www/shopware.local/custom/plugins/WeArePlanetPayment');
		break;
}
