...
composer require weareplanet/sdk 4.2.2
php bin/console plugin:refresh
php bin/console plugin:install --activate --clearCache WeArePlanetPayment
```
...
[Documentation](https://plugin-documentation.weareplanet.com/weareplanet/shopware-6/5.0.11/docs/en/documentation.html)
